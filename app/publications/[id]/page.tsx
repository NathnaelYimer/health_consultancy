...
export default function PublicationDetail({ params }: Params) {
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 container mx-auto px-4 lg:px-8 py-16">
          ...
          <p className="text-muted-foreground">We couldn't find the requested publication.</p>
          <div className="mt-6">
            <Link href="/publications" className="underline">Back to publications</Link>
          </div>
        </main>
        <Footer />
      </div>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 lg:px-8 py-16">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">{pub.authors} — {pub.year}</p>
            <p className="mb-6">{pub.abstract}</p>
            <div className="flex gap-4">
              <Link href={pub.pdf ?? '#'} className="underline">Download PDF</Link>
              <Link href="/publications" className="underline">Back to publications</Link>
            </div>
          </CardContent>
        </Card>
